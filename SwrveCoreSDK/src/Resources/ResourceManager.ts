...
export class ResourceManager {
  ...
  public getAttributeAsString(
    resourceId: string,
    attributeId: string,
    defaultValue: string
  ): string {
    return this.getResource(resourceId).getAttributeAsString(
      attributeId,
      defaultValue
    );
  }

  public getAttributeAsNumber(
    resourceId: string,
    attributeId: string,
    defaultValue: number
  ): number {
    return this.getResource(resourceId).getAttributeAsNumber(
      attributeId,
      defaultValue
    );
  }

  public getAttributeAsBoolean(
    resourceId: string,
    attributeId: string,
    defaultValue: boolean
  ): boolean {
    return this.getResource(resourceId).getAttributeAsBoolean(
      attributeId,
      defaultValue
    );
  }
