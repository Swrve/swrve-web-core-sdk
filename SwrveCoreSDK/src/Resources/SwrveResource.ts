...
export class SwrveResource {
  public readonly getAttributeAsString: (
    attributeId: string,
    defaultValue: string
  ) => string;

  public readonly getAttributeAsNumber: (
    attributeId: string,
    defaultValue: number
  ) => number;

  public readonly getAttributeAsBoolean: (
    attributeId: string,
